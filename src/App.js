...
export default function App(){
  ...
  return(
    <div style={{maxWidth:"95vw",margin:"0 auto",fontFamily:"system-ui,sans-serif",background:"#f8f8f8",minHeight:"100vh"}}>
      ...
      {/* Bottom Nav */}
      <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:"95vw",background:"#fff",borderTop:"0.5px solid #eee",display:"flex",zIndex:100}}>
        {tabs.map(t=>(
